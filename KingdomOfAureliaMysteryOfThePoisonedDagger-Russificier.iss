...
; Всегда меняются
#define GameName "Kingdom of Aurelia Mystery of the Poisoned Dagger"                                          ; Название игры
#define GameNameDash "KingdomOfAurelia-MysteryOfThePoisoned-Dagger"                                          ; Название игры
#define GameNameEXE "Kingdom_of_Aurelia_PE"                                                              ; Название exe файла игры
#define GameVer "1"                                                                     ; Версия игры
#define GameAppIdSteam "550390"                                                             ; Ид игры в стиме
#define Path "Kingdom_of_Aurelia_PE_Data"                                                             ; Ид игры в стиме
; От ситуации зависит
#define AppDescription "Королевство Аурелия: Тайна Отравленного Кинжала"                                     ; Описание программы
...
[Setup]
;Номер приложения для его удаление лучше все время не забывать разный совать. Проверка уникальный для: Kingdom of Aurelia: Mystery of the Poisoned Dagger Russificier
AppId={{1F06E016-175D-4F2B-9703-F92817915D72}
...
Source: {#Location}\{#GameNameDash}\*;      DestDir: "{tmp}"; Flags: deleteafterinstall
